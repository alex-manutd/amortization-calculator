...
public class AmortizationCalculator {
    ...
    public static void printTable(double principal, int numberOfPayments) {
        ...
        System.out.println("=======================Your Mortgage Payoff Table========================");
        System.out.println("=======================--------------------------========================");
        System.out.format("%5s %12s %18s %18s %16s \n", headers);
        System.out.println("=========================================================================");
        
        // Establish values for the variables which we will use in the calculations
    ...
    private static void promptToSaveCSV(Object[][] rows) {
        ...
        if ("yes".equalsIgnoreCase(response)) {
            try {
                FileWriter fileWriter = new FileWriter("./src/amortizationcalculator/amortization_table.csv");
